...
class AllSprites(pg.sprite.Sprite):
    def __init__(self, all_sprites, screen):
        ...
        Enemy(self.enemy_sprites, (WIGHT_OF_SCREEN / 10 * 2, HEIGHT_OF_SCREEN / 10 * 4), "vertical")
        Enemy(self.enemy_sprites, (WIGHT_OF_SCREEN / 10 * 8, HEIGHT_OF_SCREEN / 10 * 0), "vertical")
        Enemy(self.enemy_sprites, (WIGHT_OF_SCREEN / 10 * 6.5, HEIGHT_OF_SCREEN / 10 * 4), "vertical")
        Enemy(self.enemy_sprites, (WIGHT_OF_SCREEN / 10 * 5, HEIGHT_OF_SCREEN / 10 * 5.5), "vertical")
        Enemy(self.enemy_sprites, (WIGHT_OF_SCREEN / 10 * 4, HEIGHT_OF_SCREEN / 10 * 4), "horizontal")
        Enemy(self.enemy_sprites, (WIGHT_OF_SCREEN / 10 * 3, HEIGHT_OF_SCREEN / 10 * 5.5), "horizontal")
        # set boxes
